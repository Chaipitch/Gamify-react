...
function Game({name,released,image,id}) {
  ...
  return (
    <motion.div layoutId={id} onClick={loadDetailHandler} className='min-h-[30vh] shadow-lg rounded-lg overflow-hidden bg-white/30 backdrop-opacity-60 backdrop-blur-sm'>
      <Link to={`/game/${id}`}>
        <div>
